...
function Perfil() {
    ...
    return (
        <div>
            ...
            {Datos.map((DatosPefilCliente, index) => (

                <section key={index}>
                    <div class='ContenedorNombreAdmin'>
                        <h1 class='NombrePerfilAdmin'>{DatosPefilCliente.primer_nombre} {DatosPefilCliente.segundo_nombre} {DatosPefilCliente.primer_apellido} {DatosPefilCliente.segundo_apellido}</h1>
                    </div>
                    <div class='ContenedorDocumentoAdmin'>
                        <h4 class='DocumentoPerfilAdmin'>Documento - {DatosPefilCliente.tipo_documento} {DatosPefilCliente.documento}</h4>
                    </div>
                    <div class='ContenedorCorreoAdmin'>
                        <h4 class='CorreoPerfilAdmin'>Correo - {DatosPefilCliente.correo}</h4>
                    </div>
                    <div class='ContenedorTelefonoAdmin'>
                        <h4 class='TelefonoPerfilAdmin'>Telefeono - {DatosPefilCliente.telefono}</h4>
                    </div>
                    <div class='ContenedorDireccionAdmin'>
                        <h4 class='DireccionPerfilAdmin'>Direccion - {DatosPefilCliente.direccion}</h4>
                    </div>
